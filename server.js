...
app.get("/catalog/items", async (req, res) => {
    try {
        ...
        const r = await axios.get(
            ...
            `&category=${category}&limit=${limit || 25}`
        );
...
app.get("/apisite/thumbnails/v1/users/avatar", (req, res) => {
    ...
    res.json({
        data: [{
            imageUrl: `https://www.roblox.com/headshot-thumbnail/image?userId=${userId}&width=420&height=420&format=png`
        }]
    });
});
